...
// Fonction de test (pour debug dans la console)
function testKill() {
    const testData = {
        victim: "TestPlayer#123",
        killer: "You",
        points: 100,
        bonuses: [
            { type: "headshot", points: 50 },
            { type: "killstreak", points: 75, count: 3 }
        ],
        totalPoints: 225
    };
...
// Rendre la fonction test disponible globalement (pour debug)
